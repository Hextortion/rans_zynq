...
vlog -vopt +acc -sv -sv12compat +incdir+rtl +incdir+sim +define+SIMULATION -work work rtl/axi_stream_if.sv
vlog -vopt +acc -sv -sv12compat +incdir+rtl +incdir+sim +define+SIMULATION -work work rtl/axi_lite_if.sv
vlog -vopt +acc -sv -sv12compat +incdir+rtl +incdir+sim +define+SIMULATION -work work rtl/rans_axi.sv
